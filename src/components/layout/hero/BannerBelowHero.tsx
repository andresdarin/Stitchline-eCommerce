...
const BannerBelowHero = () => {
    return (
        <div className="relative border-[var(--color1)] z-10 flex flex-col items-center text-center justify-center h-full text-[var(--color1)]">

            {/* Contenido centrado pero alineado a la izquierda */}
            <section className="flex flex-col mt-[4rem] items-center text-center justify-center px-4 md:px-0">
            ...
            {/* Loop abajo */}
            <section className="h-16 w-full mb-30">
                <CurvedLoop
